 ...
 * @author Acer Gaming
 */
public class J05016_HÓAĐƠNKHÁCHSẠN {
    ...
    public J05016_HÓAĐƠNKHÁCHSẠN(int maKH, String hoTen, String soPhong, Date ngayNhan, Date ngayTra, int tienDV) {
    ...
    public static void main(String[] args)  {
        ...
        try {
            int n=sc.nextInt();
            sc.nextLine();
            List<J05016_HÓAĐƠNKHÁCHSẠN> list = new ArrayList<>();
            ...
            for(int i=0;i<n;i++){
                ...
                J05016_HÓAĐƠNKHÁCHSẠN x =new J05016_HÓAĐƠNKHÁCHSẠN(i+1,ten,sophong,d1,d2,tiendv);
                list.add(x);
            }
            Collections.sort(list,new Comparator<J05016_HÓAĐƠNKHÁCHSẠN>(){
                @Override
                public int compare(J05016_HÓAĐƠNKHÁCHSẠN o1, J05016_HÓAĐƠNKHÁCHSẠN o2) {
            ...
            for(J05016_HÓAĐƠNKHÁCHSẠN x : list ){
