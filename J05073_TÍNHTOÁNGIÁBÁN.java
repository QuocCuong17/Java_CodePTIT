 ...
 * @author Acer Gaming
 */
public class J05073_TÍNHTOÁNGIÁBÁN {
    private String ma;
    private long donGia,soLuong;
    private double thue,pvc,tongTien;
    public J05073_TÍNHTOÁNGIÁBÁN(String ma, long donGia, long soLuong) {
        this.ma = ma;
        this.donGia = donGia;
    ...
    public static void main(String[] args) {
        ...
        ArrayList<J05073_TÍNHTOÁNGIÁBÁN> list = new ArrayList<>();
        int n=sc.nextInt();
        for(int i=0;i<n;i++){
            String ma=sc.next();
            long dongia=sc.nextLong();
            long sl=sc.nextLong();
            J05073_TÍNHTOÁNGIÁBÁN x = new J05073_TÍNHTOÁNGIÁBÁN(ma,dongia,sl);
