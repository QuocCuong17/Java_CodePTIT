...
public class J05079 {
    ...
    public J05079(String maMH, String tenMH, String nhomLop, String tenGV) {
        this.maMH = maMH;
        this.tenMH = tenMH;
    ...
    public static void main(String[] args) {
        ...
        int n=sc.nextInt();
        sc.nextLine();
        List<J05079> list = new ArrayList<>();
        for(int i=0;i<n;i++){
            String maMH=sc.nextLine();
            String tenMH=sc.nextLine();
            String nhomLop=sc.nextLine();
            String tenGV=sc.nextLine();
            J05079 x = new J05079(maMH,tenMH,nhomLop,tenGV);
            list.add(x);
        }
        Collections.sort(list,new Comparator<J05079>(){
            @Override
            public int compare(J05079 o1, J05079 o2) {
